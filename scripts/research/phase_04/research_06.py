...
# %% 1 -
model  = MLPClassifier(random_state = 1337)
scaler = MinMaxScaler()
...
plt.plot_setup()
sns.sns_setup()
plt.roc_curve(train_fpr, train_tpr, "06_01", "MLP (Train Data)", "phase_04")
...
# Sensitivity for cut-off 0.666: 78.17%
# Specificity for cut-off 0.666: 62.15%
...
plt.plot_setup()
sns.sns_setup()
plt.roc_curve(test_fpr, test_tpr, "06_02", "MLP (Test Data)", "phase_04")
...
# Sensitivity for cut-off 0.666: 76.92%
# Specificity for cut-off 0.666: 62.89%
