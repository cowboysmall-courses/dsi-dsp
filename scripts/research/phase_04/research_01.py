...
plt.plot_setup()
sns.sns_setup()
plt.roc_curve(train_fpr, train_tpr, "01_01", "Logistic Regression (Train Data)", "phase_04")
...
plt.plot_setup()
sns.sns_setup()
plt.roc_curve(test_fpr, test_tpr, "01_02", "Logistic Regression (Test Data)", "phase_04")
