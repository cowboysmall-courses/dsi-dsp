...
It looks like the compound sentiment scores, if slightly skewed, could be 
useful as an extra feature - but without access to historical tweets, it would 
be impossible to tell conclusively, Nevertheless it should be investigated 
further.
